export const ADD_TASK_DESCRIPTION = `A tool for adding events to a todo list and for adding reminders
...
`
export const GET_TASK_DESCRIPTION = `A tool gettings all the tasks and reminders on the todo list. Be specific with what information you want about the tasks returned
